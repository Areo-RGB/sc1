<script lang="ts">
  ...
  import { Chart, P, Button, Timeline, TimelineItem, Breadcrumb, BreadcrumbItem, Heading } from 'flowbite-svelte';
  ...
  let { title = "Dashboard", showBreadcrumb = true }: Props = $props();
...
<div class="grid grid-cols-1 pt-2 xl:gap-4 xl:px-0 dark:bg-gray-900">
  {#if showBreadcrumb}
